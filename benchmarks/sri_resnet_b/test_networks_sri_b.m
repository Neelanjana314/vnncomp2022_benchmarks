...
%% network 1
net_sri1 = importONNXNetwork('./onnx/resnet_3b2_bn_mixup_ssadv_4.0_bs128_lr-1_v2.onnx', 'OutputDataFormats',"BC");
nnvnet1 = matlab2nnv(net_sri1);
properties1 = load_vnnlib('./vnnlib/cifar10_spec_idx_33_eps_0.00350.vnnlib');
