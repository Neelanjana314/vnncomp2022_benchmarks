...
%% network 1
net_cifar100_tiny1 = importONNXNetwork('./onnx/CIFAR100_resnet_large.onnx', 'OutputDataFormats',"BC"); %reshape
nnvnet1 = matlab2nnv(net_cifar100_tiny1);
properties1 = load_vnnlib('./vnnlib/CIFAR100_resnet_large_prop_idx_37_sidx_2045_eps_0.0039.vnnlib');

test1 = properties1.lb;
test1 = python_reshape(test1,net_cifar100_tiny1.Layers(1,1).InputSize);
pred_net1 = predict(net_cifar100_tiny1,test1);
...
%% network 2
net_cifar100_tiny2 = importONNXNetwork('./onnx/CIFAR100_resnet_medium.onnx', 'OutputDataFormats',"BC"); %reshape
...
%% network 3
net_cifar100_tiny3 = importONNXNetwork('./onnx/CIFAR100_resnet_small.onnx', 'OutputDataFormats',"BC"); %reshape
nnvnet3 = matlab2nnv(net_cifar100_tiny3);
properties3 = load_vnnlib('./vnnlib/CIFAR100_resnet_small_prop_idx_939_sidx_5683_eps_0.0039.vnnlib');

test3 = properties3.lb;
test3 = python_reshape(test3,net_cifar100_tiny3.Layers(1,1).InputSize);
pred_net3 = predict(net_cifar100_tiny3,test3);
...
%% network 4
net_cifar100_tiny4 = importONNXNetwork('./onnx/CIFAR100_resnet_super.onnx', 'OutputDataFormats',"BC"); %reshape
...
if all(abs(squeeze(lb4) - pred_nnv4)<0.001 == 1)
    fprintf("reachset value is same for nnvnet predict and nnvnet reach 4\n")
end


%% network 5
net_cifar100_tiny5 = importONNXNetwork('./onnx/TinyImageNet_resnet_medium.onnx', 'OutputDataFormats',"BC"); %reshape
nnvnet5 = matlab2nnv(net_cifar100_tiny5);
properties5 = load_vnnlib('./vnnlib/TinyImageNet_resnet_medium_prop_idx_126_sidx_1545_eps_0.0039.vnnlib');

test5 = properties5.lb;
test5 = python_reshape(test5,net_cifar100_tiny5.Layers(1,1).InputSize);
pred_net5 = predict(net_cifar100_tiny5,test5);
...
if all(abs(lb5 - pred_nnv5)<0.001 == 1)
